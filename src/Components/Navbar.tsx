...
function Navbar({data , toggleTrueFalse}) {
  ...
  return (
    <div id="navbar" className='bg-black flex items-center text-white p-4  w-full fixed z-50 site-menu xs:hidden '>
      ...
      <ul className='menu_list flex justify-center items-center  w-full ml-10'>
        ...
        <li className='ml-auto w-2/6'>
          <form>   
              <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only ">Search</label>
              <div className="relative">
                  <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                      <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                  </div>
